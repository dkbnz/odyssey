...
create table vote (
  ...
  is_up_vote                    tinyint(1) default 0 not null,
...
alter table hint drop foreign key fk_hint_objective_id;
drop index ix_hint_objective_id on hint;

alter table hint drop foreign key fk_hint_creator_id;
drop index ix_hint_creator_id on hint;
...
alter table vote drop foreign key fk_vote_voter_id;
drop index ix_vote_voter_id on vote;

alter table vote drop foreign key fk_vote_target_hint_id;
drop index ix_vote_target_hint_id on vote;
