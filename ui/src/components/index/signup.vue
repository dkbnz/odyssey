        ...
        <div v-if="showSecond" id="secondSignup">
            <b-form>
                <b-row>
                    <b-col>
                        <b-form-group
                            ...
                            <b-form-select id="nationality" v-model="nationalities" :state="nationalityValidation"
                                           multiple trim>
                                <option v-for="nationality in nationalityOptions" :value="nationality.id">
                                    {{nationality.nationality}}
                                </option>
                            </b-form-select>
                            <b-form-invalid-feedback :state="nationalityValidation"> Please select at least one
                                nationality.
                            </b-form-invalid-feedback>
                    ...
                    <b-col>
                        <b-form-group
                            ...
                            <b-form-invalid-feedback :state="passportValidation"> Please select at least one passport
                                country.
                            </b-form-invalid-feedback>
                ...
                <b-form-group
                    ...
                    <b-form-invalid-feedback :state="travTypeValidation" align="center"> Please select at least one
                        traveller type.
                    </b-form-invalid-feedback>
                    <b-form-valid-feedback :state="travTypeValidation" align="center"> Looks Good
